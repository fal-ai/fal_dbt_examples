...
def find_ideal_min_samples(X: np.array, range_min_samples: list, window_size: int):
    ...
    window_size: int
        An integer determining the size of the window for the
        application of sliding windows.
    Returns
    -------
...
# This is the same slack file sending function from forecast_slack.py
